...
public class crearXML {
	...
	public static void c_XML(DataHandler dh_det, DataHandler dh_cab,
		...
		/*
		 * System.out.println("Aca-> Código de régimen de percepción:       "+myAca
		 * .get_codRegPercepcion());
		 * System.out.println("Aca-> Base imponible de percepción:          "
		 * +myAca.get_mtoBaseImponiblePercepcion());
		 * System.out.println("Aca-> Monto de la percepción:                "
		 * +myAca.get_mtoPercepcion());
		 * System.out.println("Aca-> Monto total incluido la percepción:    "
		 ...
		 * System.out.println("Aca-> Dirección del cliente (Cód de país):   "
		 * +myAca.get_codPaisCliente());
		 * System.out.println("Aca-> Dirección del cliente (Cód de ubigeo): "
		 * +myAca.get_codUbigeoCliente());
		 * System.out.println("Aca-> Dir. cliente (Dir completa):           "
		 * +myAca.get_desDireccionCliente()); //
		 * System.out.println("Aca-> Cód de país en que se entrega el bien: "
		 * +myAca.get_codPaisEntrega());
		 * System.out.println("Aca-> Guia:                                  "
		 * +myAca.get_guia()); //
		 * System.out.println("Aca-> Cód ubigeo donde se entrega el bien:   "
