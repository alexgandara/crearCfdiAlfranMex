...
public class cabecera {
	...
	public String get_uuid_nc() {
		return _uuid_nc;
	}
	public void set_uuid_nc(String _uuid_nc) {
		this._uuid_nc = _uuid_nc;
	}
	public String get_uso_cfdi() {
		return _uso_cfdi;
	}
	public void set_uso_cfdi(String _uso_cfdi) {
		this._uso_cfdi = _uso_cfdi;
	}
